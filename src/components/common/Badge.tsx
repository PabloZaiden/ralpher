...
const variantClasses: Record<BadgeVariant, string> = {
  ...
  info: "bg-blue-100 text-blue-800 dark:bg-gray-800 dark:text-blue-300",
  // Loop status variants
  idle: "bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300",
  planning: "bg-cyan-100 text-cyan-800 dark:bg-gray-800 dark:text-cyan-300",
  running: "bg-blue-100 text-blue-800 dark:bg-gray-800 dark:text-blue-300",
  completed: "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300",
  stopped: "bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300",
  failed: "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300",
  // Final states
  merged: "bg-purple-100 text-purple-800 dark:bg-gray-800 dark:text-purple-300",
  pushed: "bg-indigo-100 text-indigo-800 dark:bg-gray-800 dark:text-indigo-300",
