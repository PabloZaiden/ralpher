      ...
      <div className="space-y-4">
        <div>
          ...
          <textarea
            ...
            rows={10}
            disabled={submitting}
            className="w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-50"
          />
        ...
        <div className="bg-blue-50 dark:bg-gray-900/40 border border-blue-200 dark:border-gray-700 rounded-md p-3">
